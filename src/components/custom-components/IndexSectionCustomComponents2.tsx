...
const IndexSectionCustomComponents2: React.FC = () => {
    ...
    <div className="grid lg:grid-cols-2 gap-16 items-center">
      <div className="space-y-8">
        ...
        <div className="flex flex-wrap gap-4 hero-fade">
          <Link href="/collection" className="bg-lime-400 text-black font-medium px-6 py-3 rounded-full hover:bg-lime-300 transition-all hover:scale-105">Get started</Link>
      ...
      <div className="relative">
        <div className="grid grid-cols-3 gap-4 transform rotate-3 hover:rotate-0 transition-transform duration-700 card-stack">
          <div className="bg-linear-to-br from-emerald-400 to-teal-600 rounded-2xl p-4 aspect-3/4 transform hover:-translate-y-4 transition-transform duration-500 shadow-2xl card-item">
            <div className="text-black font-bold text-sm">SCROLL</div>
            <div className="mt-auto text-black/60 text-xs">01</div>
          </div>
          <div className="bg-linear-to-br from-orange-400 to-red-500 rounded-2xl p-4 aspect-3/4 transform hover:-translate-y-4 transition-transform duration-500 shadow-2xl -mt-8 card-item">
            <div className="text-black font-bold text-sm">THUNDER CAT</div>
            <div className="mt-auto text-black/60 text-xs">02</div>
          </div>
          <div className="bg-linear-to-br from-yellow-300 to-amber-500 rounded-2xl p-4 aspect-3/4 transform hover:-translate-y-4 transition-transform duration-500 shadow-2xl card-item">
            <div className="text-black font-bold text-sm">MOTION</div>
            <div className="mt-auto text-black/60 text-xs">03</div>
          </div>
          <div className="bg-linear-to-br from-cyan-400 to-blue-500 rounded-2xl p-4 aspect-3/4 transform hover:-translate-y-4 transition-transform duration-500 shadow-2xl -mt-4 card-item">
            <div className="text-black font-bold text-sm">EFFECTS</div>
            <div className="mt-auto text-black/60 text-xs">04</div>
          </div>
          <div className="bg-linear-to-br from-lime-400 to-green-500 rounded-2xl p-4 aspect-3/4 transform hover:-translate-y-4 transition-transform duration-500 shadow-2xl card-item">
            <div className="text-black font-bold text-sm">ANIMATE</div>
            <div className="mt-auto text-black/60 text-xs">05</div>
          </div>
          <div className="bg-linear-to-br from-pink-400 to-rose-500 rounded-2xl p-4 aspect-3/4 transform hover:-translate-y-4 transition-transform duration-500 shadow-2xl -mt-8 card-item">
  ...
  <div className="mt-32 text-center">
    ...
    <div className="w-px h-16 bg-linear-to-b from-lime-400 to-transparent mx-auto scroll-indicator" />
  </div>
</section>
